...
public class PIDControlTest extends LinearOpMode{
    ...
    //Runs robot to target angle until within 5 degrees
    void turn(double originHeading, double targetHeading) {
        double target = targetHeading;
        double origin = originHeading;

        double startPower = 0.3;
        FrontLeft.setPower(startPower);
        BackLeft.setPower(startPower);
        FrontRight.setPower(startPower);
        BackRight.setPower(startPower);
    ...
    //Method to turn the robot right using PID control
    /* Algorithm Steps:
     * 1. Get Current Heading
     * 2. Get Target Heading
